...
<h4 class="mb-3">Accept Returns</h4>
<?php if ($message) { ?><div class="alert alert-info"><?php echo htmlspecialchars($message); ?></div><?php } ?>
<table class="table table-striped">
<thead><tr><th>ID</th><th>Book</th><th>User</th><th>Status</th><th></th></tr></thead>
<tbody>
...
<form method="post" action="?route=admin/return"><input type="hidden" name="issue_id" value="<?php echo (int)$it['id']; ?>"><button class="btn btn-sm btn-outline-danger">Mark Returned</button></form>
<?php } ?>
</td>
</tr>
<?php } ?>
